...
public abstract class AbstractChannel extends DefaultAttributeMap implements Channel {
     ...
     *为每一个隧道赋予一个独立的id,根据机器地址mac,进程id,以及其他
     * @param parent
    ...
    protected abstract class AbstractUnsafe implements Unsafe {
    	...
    	//用于数据的传输，使用堆，不需要在将数据复制到内存中，产生其他的内存消耗
        ...
        private void register0(ChannelPromise promise) {
            try {
                ...
                pipeline.invokeHandlerAddedIfNeeded();//运行addLast方法加进来的节点content {@link ChannelInitializer}的initChannel()方法,并加进其他的节点
